...
class SuperSprite(pygame.sprite.Sprite):
    ...
    def __init__(self, scene):
        ...
        self.font = pygame.font.Font("acmesa.TTF", 30)
...
class Scene(object):
    ...
    def __init__(self):
        ...
        """
        pygame.init()
        self.screen = pygame.display.set_mode((640, 700))
...
class Label(pygame.sprite.Sprite):
    ...
    def __init__(self, fontName = "acmesa.TTF"):
        pygame.sprite.Sprite.__init__(self)
...
class MultiLabel(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.font = pygame.font.Font("acmesa.TTF", 20)
